...
public class FastWifiBadgeLogic implements BadgeLogic {
    private static final String NAME = "Быстрый Wi-Fi";
    private static final int MIN_REVIEWS = 4;
    private static final double MIN_PERCENTAGE = 0.7;
    private static final int DESIRED_RATING = 4;
    ...
    public boolean isReviewEligible(Review review) {
        ...
        return review.getWifiRating() != 0 && review.getWifiRating() == DESIRED_RATING;
    }
}
